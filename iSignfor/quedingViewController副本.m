...
-(UITableViewCell *)customCellWithOutXib:(UITableView *)tableView withIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil){
        ...
        CGRect classRect = CGRectMake(75, 55, 300, 14);
        ...
        //货主
        CGRect stuNameTipRect = CGRectMake(10, 90, 250, 12);
        ...
        CGRect stuNameRect = CGRectMake(75, 90, 250, 14);
...
-(void)signqueding
{
    ...
    NSURL *url = [NSURL URLWithString: @"http://125.88.8.30:8887/AndroidWebservice/SingforBAPort"];
    // 根据上面的URL创建一个请求
